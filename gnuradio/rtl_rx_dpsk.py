...
# Title: Rtl Rx Dpsk
# Generated: Mon Feb 24 21:31:35 2020
##################################################
...
class rtl_rx_dpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.digital_dxpsk_demod_0, 0))
...
def main(top_block_cls=rtl_rx_dpsk, options=None):
