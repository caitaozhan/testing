...
# Title: Qpsk
# Generated: Wed Feb 26 21:27:42 2020
##################################################
...
class qpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(map(int, numpy.random.randint(0, 2, int(10e6))), True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, self.samp_rate*8)
