...
# Generated: Tue Feb 25 21:15:42 2020
##################################################
...
class fm_radio_hackrf(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Fm Radio Hackrf")
...
def main(top_block_cls=fm_radio_hackrf, options=None):
